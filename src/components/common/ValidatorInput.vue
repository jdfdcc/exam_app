<template>
  <label class="va_ipt " v-bind:class="[btnClear && inputValue?'has_opt':'']" style="width:100%">
...
.has_opt {
  ...
  .btn_opt {
    float: right; // background-image: url(../../assets/img/icon_clear.png);
    position: absolute;
    margin-top: -51px;
    right: 0px;
    width: 38px;
    ...
    background-size: 14px;
    height: 28px; // background-color:white;
    opacity: 0;
  }
}
</style>
