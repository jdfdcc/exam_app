      ...
      <section v-bind:style="{'min-height':screenHeight - 81 +'px'}">
        ...
        <section class="mine-avatar mine-section mg-lg">
          ...
          <div class="mine-inner-group mg-lg">
            <ValidatorInput :form.sync="validateObj.addrDetail" :validator="{rules:['require',{reg:/^\S{0,50}$/,msg:'详细地址不超过50个字符'}]}"
...
export default {
  ...
  components: {
    ...
    'toast': Toast,
    DistrictAddress: r => { require(['../../components/common/DistrictAddress'], r) },
  },
  data() {
    return {
      addressData: {
